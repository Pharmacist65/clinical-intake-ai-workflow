...
The summary is generated by the deterministic `Mock` provider behind `IAiSummaryService`. If a summary already exists, it is updated and previous risk flags are replaced. This keeps regeneration deterministic, avoids stale flags, and ensures the app runs without external AI calls or API keys.
...
```json
{
  ...
  "transcriptText": "Family described sleep disruption and school support needs.",
  "capturedAt": null,
  "createdBy": "demo-user",
